...
import 'package:spinkit_schema_parser_example/main.dart';
...
void main() {
  testWidgets('Counter increments smoke test', (WidgetTester tester) async {
    ...
    SpinkitSchemaParser.registerParsers();
    ...
    expect(find.byElementType(SpinKitRotatingCircle), findsOneWidget);
  });
}
